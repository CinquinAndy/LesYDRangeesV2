...
<section class="_yd_background w-full h-screen z-10">
    <div class="relative flex justify-center items-center w-full h-full">
        <div class="_yd_logo w-full m-5 md:w-1/3 md:m-0">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                 viewBox="0 0 946.24 590.52">
                <defs>
                    <style>
                        .cls-1 {
...
<!--Group -> citation-->
<!-- Textarea -> citation_sentence-->
<!-- Text -> citation_author-->
<!---->
<!--Text -> first_section_title-->
<!--Text -> title_around_photo-->
<!--WysiwygEditor -> description-->
<?php $arrayCitation = get_field("citation") ?>
<section class="my-20 lg:m-40">
    <div class="_yd_citation w-full flex justify-center items-center p-2 lg:p-20" data-aos-once="true"
         data-aos="zoom-in">
        <div
            class="border-l-4 border-yd_purple-700 py-10 px-5 lg:p-20 flex justify-center items-center flex-wrap relative">
            <img class="_yd_quotes w-24 lg:w-40 absolute opacity-5 top-0 left-0 ml-10 _yd_reversed"
                 draggable="false"
                 src="<?= get_template_directory_uri() ?>/assets/images/right-quotes-symbol.svg"
                 alt="quote - Les YD Rangées">
            <div class="w-full relative">
                <div class="w-full flex justify-center items-center">
                    <p class="font-bold text-xl lg:text-4xl text-yd_blue-400 uppercase leading-relaxed"
                       data-aos-once="true" data-aos="fade-up" data-aos-delay="100">
                        <?= $arrayCitation["citation_sentence"] ?>
                    </p>
                </div>
                <div class="w-full absolute">
                    <p class="font-bold text-right uppercase text-yd_purple-400 texl-lg lg:text-2xl mt-4 lg:mt-10"
                       data-aos-once="true" data-aos="fade-up" data-aos-delay="200">
                        <?= $arrayCitation["citation_author"] ?>
                    </p>
                </div>
            </div>
            <img class="_yd_quotes w-24 lg:w-40 absolute opacity-5 bottom-0 right-0"
                 draggable="false"
                 src="<?= get_template_directory_uri() ?>/assets/images/right-quotes-symbol.svg"
                 alt="quote - Les YD Rangées">
        </div>
...
<section class="flex flex-col justify-center mx-0 mb-10 lg:mx-40 lg:mb-40">
    <h2 class="uppercase text-2xl font-bold text-yd_pink-500 text-center"><?= get_field("first_section_title") ?></h2>
    <div class="w-full flex justify-center items-center p-10">
        <hr class="w-1/3 border-yd_pink-500 border">
    </div>

    <div class="w-full flex justify-center items-center p-10 mb-10 lg:p-20 lg:my-20" data-aos-once="true"
         data-aos="zoom-out-down">
        <div class="_yd_txt_around_image">
            <figure class="relative">
                <?php $photo = get_field("photo") ?>
                <img class="rounded-full shadow-2xl h-250px w-250px lg:h-500px lg:w-500px"
                     draggable="false"
                     src="<?= esc_url($photo['url']) ?>"
                     alt="<?= esc_attr($photo['alt']) ?>">
                <h2 class="_yd_letters_block text-yd_gray-200">
                    <?php
                    $title_around_photo = str_split(get_field("title_around_photo"));
                    echo "<span>&nbsp;</span>";
                    foreach ($title_around_photo as $letter) {
                        echo "<span>".(($letter===' ')?'&nbsp;':$letter)."</span>";
                    }
                    echo "<span>&nbsp;</span>"
                    ?>
                </h2>
    ...
    <div class="w-full flex justify-center items-center _yd-center-justified" data-aos-once="true"
        ...
        <div
            class="_yd_wizi _yd-gradient-textColor-adjust-on-logo w-full mx-5 md:w-1/2 lg:m-0 flex justify-center items-center grid grid-cols-1 text-base lg:text-xl">
